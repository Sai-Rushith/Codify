...
// Theme changed to strict black & white only — logic unchanged
          ...
          <div className="flex flex-col gap-5 lg:flex-row">
            ...
            <div className="flex flex-col gap-2 lg:w-[48%]">
              ...
              <select
                name="gender"
                id="gender"
                className="w-full rounded-md border border-white/20 bg-white/5 py-2 px-3 text-white"
                {...register("gender", { required: true })}
                defaultValue={user?.additionalDetails?.gender}
              >
                {genders.map((ele, i) => {
                  return (
                    <option key={i} value={ele} className="bg-black text-white">
                      {ele}
                    </option>
                  )
                })}

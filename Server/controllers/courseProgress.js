...
exports.updateCourseProgress = async (req, res) => {
  ...
  try {
    ...
    // Find or create course progress (use exact field names your schema uses)
    ...
    if (!courseProgress) {
      // create a new progress doc if not present
    ...
    return res.status(200).json({ success: true, message: "Course progress updated", courseProgress })
  } catch (error) {
    console.error(error)
